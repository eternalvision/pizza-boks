(function() {
    ...
    function k(b, c) {
        ...
        function e() {
            ...
            a.style.left = 0;
            a.style.right = 0;
            a.style.backgroundColor = 'rgba(254, 203, 36, 0)';
        ...
        function r() {
            ...
            for (
                d('#' + b + ' .ism-tmp-clone').remove(); 0 < d('#' + b + ' .ism-frame').length;
        ...
        function a() {
            ...
            A &&
                ...
                ('once' == f.play_type && p == m() - 2 ?
                    ...
                    (y(0), g()) :
                    ('loop' == f.play_type && p == m() - 1 ? y(0) : y(a),
                        v()));
        }
        ...
        function ca() {
            if (f.radios) {
                ...
                z = d('#' + b + ' .ism-radios');
                'thumbnail' == f.radio_type &&
                    z.addClass('ism-radios-as-thumbnails');
                for (var a = 0; a < m(); a++)
                    0 == a ?
                    z.append(
                        "<li class='ism-radio-" +
        ...
        function Z(a) {
            f.radios &&
                (d('#' + b + ' .ism-radios li').removeClass('active'),
                    ...
                    d(a).addClass('active'),
                    d(a).find('input').attr('checked', 'checked'));
        }
        ...
        function O(a) {
            ...
            'none' != f.image_fx &&
                ('zoompan' == f.image_fx ?
                    d(
                        '#' + b + ' .ism-slide-' + a + ' .ism-img-frame'
                    ).addClass('ism-zoom-pan') :
                    'zoomrotate' == f.image_fx &&
                    d(
                        '#' + b + ' .ism-slide-' + a + ' .ism-img-frame'
                    ).addClass('ism-zoom-rotate'));
        }

        function W() {
            d('#' + b + ' .ism-slide .ism-img-frame').removeClass(
                'ism-zoom-pan'
            );
            d('#' + b + ' .ism-slide .ism-img-frame').removeClass(
                'ism-zoom-rotate'
        ...
        function R(a, b) {
            f.captions[a] &&
                ...
                setTimeout(function() {
                    n.find('.ism-slide-' + a + ' .ism-caption-' + b).css(
                        'visibility',
                        'visible'
                    );
                    n.find('.ism-slide-' + a + ' .ism-caption-' + b).addClass(
                        'ism-caption-anim'
                    );
        ...
        this.enableButtons = function(a) {
            !0 !== a ||
                f.buttons ||
                (X(), d('#' + b + ' .ism-button').remove(), T());
        };
        this.enableRadios = function(a) {};
        this.setRadioType = function(a) {
            'thumbnail' == a
                ?
                d('#' + b + ' .ism-radios').addClass(
                    'ism-radios-as-thumbnails'
                ) :
                d('#' + b + ' .ism-radios').removeClass(
                    'ism-radios-as-thumbnails'
                );
        };
    ...
    e.prototype.removeAttr = function(b) {
        for (var c = 0; c < this.nodes.length; c++)
            this.nodes[c].removeAttribute(b);
    };
    ...
    d.prototype = {
        ...
        calculateValuePrecision: function() {
            var a = this.options.xPrecision || Math.abs(this.bounds.availWidth),
                b =
                this.options.yPrecision ||
                Math.abs(this.bounds.availHeight);
        ...
        onHandleClick: function(a) {
            (a.target &&
                0 <= a.target.className.search(/ism-(button|radio)/)) ||
            !this.activity ||
                (l(a), M(a));
        },
        ...
        enable: function() {
            this.disabled = !1;
            this.handle.className = this.handle.className.replace(
                /\s?disabled/g,
                ''
            );
        },
        ...
        setStep: function(a, b, c) {
            this.setValue(
                this.options.steps && 1 < a ?
                (a - 1) / (this.options.steps - 1) :
                0,
                this.options.steps && 1 < b ?
                (b - 1) / (this.options.steps - 1) :
                0,
                c
            );
        },
        ...
        glide: function() {
            ...
            Math.abs(a[0]) > this.valuePrecision[0] ||
                ...
                ((this.value.current[0] +=
                        a[0] *
                        Math.min((this.options.speed * this.timeOffset) / 25, 1)),
        ...
        animateSlide: function() {
            for (
                var a = this.value.target[0] - this.value.current[0],
                    ...
                    d = c - 0.5,
                    d = (-3 * d * d + 0.8) * this.step_size * 0.08; d > a;
